...
export const CHIP_CLASS =
  "inline-flex items-center justify-center gap-1.5 rounded-[var(--radius-xs)] px-3.5 py-1.5 text-sm font-medium whitespace-nowrap transition-[transform,box-shadow,background-color,border-color,color] duration-150 [transition-timing-function:var(--ease-out-soft)]";
