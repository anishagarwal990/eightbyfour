  ...
  return (
    <span className="inline-flex items-center" style={{ gap: 13 }}>
      ...
      >
        ...
        <span style={{ fontSize: digit * 0.4, fontWeight: 700, margin: "0 0.13em", transform: "translateY(-0.05em)", color: "var(--burgundy)" }}>×</span>
        <span style={{ fontSize: digit }}>4</span>
      </span>
      <span className="hidden items-center sm:inline-flex" style={{ gap: 13 }}>
