...
// Stone Panels is deliberately not here: its photography is a composite of
// slabs on a white ground, so a bleed crop leaves ragged white margins inside
// the frame. It behaves like a packshot and is treated as one.
